...
export class ProductComponent implements OnInit {
  ...
  constructor(private router: Router, private toastrService: ToastrService, 
    @Inject(ProductsService) public productsService: ProductsService, private wishlistService: WishlistService,
    private cartService: CartService, private storage: AngularFireStorage) { 
  }
  ...
  ngOnInit() { 
    ...
    // for (let image of this.product.pictures) {
    //   this.addImage(image)
    // }
  }
